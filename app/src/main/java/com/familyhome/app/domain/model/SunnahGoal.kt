...
enum class SunnahGoal(
    ...
    SUNNAH_RAWATIB(
        ...
        hadith      = "Barangsiapa yang shalat dua belas rakaat pada siang dan malam, maka Allah akan membangunkan baginya sebuah rumah di surga.",
        hadithEn    = "Whoever prays twelve rak'ahs during the day and night, Allah will build for him a house in Paradise.",
        source      = "HR. Muslim no. 728",
        sourceEn    = "Sahih Muslim, no. 728",
        dailyTarget = 12,
        unit        = "rakaat",
        unitEn      = "rak'ah(s)",
    ...
    TAHAJJUD(
        ...
        hadith      = "Rabb kita turun ke langit dunia pada sepertiga malam terakhir, lalu berfirman: 'Siapa yang berdoa kepada-Ku, Aku kabulkan...'",
        hadithEn    = "Our Lord descends to the lowest heaven in the last third of the night and says: 'Who calls upon Me so that I may answer him...'",
        source      = "HR. Bukhari no. 1145, Muslim no. 758",
        sourceEn    = "Sahih Bukhari no. 1145, Sahih Muslim no. 758",
        dailyTarget = 2,
        unit        = "rakaat",
        unitEn      = "rak'ah(s)",
    ...
    DHUHA(
        ...
        hadith      = "Setiap persendian salah seorang di antara kalian wajib bersedekah... dan dua rakaat Dhuha sudah mencukupi semua itu.",
        hadithEn    = "Every joint of each of you must give charity every day... and two rak'ahs of Dhuha prayer suffices for all of that.",
        source      = "HR. Muslim no. 720",
        sourceEn    = "Sahih Muslim, no. 720",
        dailyTarget = 2,
        unit        = "rakaat",
        unitEn      = "rak'ah(s)",
    ...
    WITR(
        ...
        hadith      = "Wahai ahli Al-Quran, kerjakanlah shalat witir, sesungguhnya Allah itu Maha Ganjil dan menyukai yang ganjil.",
        hadithEn    = "O People of the Qur'an, perform the Witr prayer, for Allah is Witr (Odd) and He loves what is odd.",
        source      = "HR. Abu Dawud no. 1416, Tirmidzi no. 453",
        sourceEn    = "Abu Dawud no. 1416, Tirmidhi no. 453",
        dailyTarget = 1,
        unit        = "kali",
        unitEn      = "time(s)",
    ...
    TILAWAH(
        ...
        hadith      = "Sebaik-baik kalian adalah yang mempelajari Al-Quran dan mengajarkannya.",
        hadithEn    = "The best among you are those who learn the Qur'an and teach it.",
        source      = "HR. Bukhari no. 5027",
        sourceEn    = "Sahih Bukhari, no. 5027",
        dailyTarget = 1,
        unit        = "kali",
        unitEn      = "time(s)",
    ...
    DZIKIR_PAGI(
        ...
        hadith      = "Tidaklah segolongan orang duduk berdzikir kepada Allah, melainkan malaikat mengelilingi mereka, rahmat menyelimuti mereka...",
        hadithEn    = "No group of people sits together in remembrance of Allah, except that angels surround them, mercy envelops them...",
        source      = "HR. Muslim no. 2700",
        sourceEn    = "Sahih Muslim, no. 2700",
        dailyTarget = 1,
        unit        = "kali",
        unitEn      = "time(s)",
    ...
    DZIKIR_PETANG(
        ...
        hadith      = "Barangsiapa yang mengucapkan 'Subhanallah wa bihamdihi' seratus kali di pagi dan petang hari, tidak ada seorang pun yang datang pada hari Kiamat dengan sesuatu yang lebih baik...",
        hadithEn    = "Whoever says 'Subhanallah wa bihamdihi' a hundred times in the morning and evening — no one on the Day of Resurrection will bring anything better...",
        source      = "HR. Muslim no. 2692",
        sourceEn    = "Sahih Muslim, no. 2692",
        dailyTarget = 1,
        unit        = "kali",
        unitEn      = "time(s)",
    ...
    SHALAT_BERJAMAAH(
        ...
        hadith      = "Shalat berjamaah lebih utama dua puluh tujuh derajat daripada shalat sendirian.",
        hadithEn    = "Congregational prayer is twenty-seven degrees more virtuous than praying alone.",
        source      = "HR. Bukhari no. 645, Muslim no. 650",
        sourceEn    = "Sahih Bukhari no. 645, Sahih Muslim no. 650",
        dailyTarget = 5,
        unit        = "kali",
        unitEn      = "time(s)",
    ...
    PUASA_SENIN_KAMIS(
        ...
        hadith      = "Amal-amal diperlihatkan pada hari Senin dan Kamis, maka aku suka jika amalku diperlihatkan saat aku sedang berpuasa.",
        hadithEn    = "Deeds are presented on Mondays and Thursdays, and I love for my deeds to be presented while I am fasting.",
        source      = "HR. Tirmidzi no. 747",
        sourceEn    = "Tirmidhi, no. 747",
        dailyTarget = 1,
        unit        = "kali",
        unitEn      = "time(s)",
    ...
    SHALAT_RAWATIB_FAJR(
        ...
        hadith      = "Dua rakaat Fajar (sunnah Subuh) lebih baik daripada dunia dan seisinya.",
        hadithEn    = "The two rak'ahs of Fajr sunnah are better than the world and all it contains.",
        source      = "HR. Muslim no. 725",
        sourceEn    = "Sahih Muslim, no. 725",
        dailyTarget = 2,
        unit        = "rakaat",
        unitEn      = "rak'ah(s)",
    ...
    SEDEKAH(
        ...
        hadith      = "Setiap hari di mana para hamba memasuki waktu pagi, ada dua malaikat yang turun. Salah satunya berdoa: 'Ya Allah, berilah orang yang berinfak itu ganti'...",
        hadithEn    = "Every morning two angels descend. One of them says: 'O Allah, give in return to the one who spends (in Your cause)...'",
        source      = "HR. Bukhari no. 1442, Muslim no. 1010",
        sourceEn    = "Sahih Bukhari no. 1442, Sahih Muslim no. 1010",
        dailyTarget = 1,
        unit        = "kali",
        unitEn      = "time(s)",
    ...
    SHALAT_ISTIKHARAH(
        ...
        hadith      = "Tidaklah seorang muslim berwudhu kemudian mengerjakan shalat dua rakaat... melainkan surga menjadi wajib baginya.",
        hadithEn    = "No Muslim performs ablution properly, then prays two rak'ahs... except that Paradise becomes obligatory for him.",
        source      = "HR. Muslim no. 234",
        sourceEn    = "Sahih Muslim, no. 234",
        dailyTarget = 1,
        unit        = "kali",
        unitEn      = "time(s)",
